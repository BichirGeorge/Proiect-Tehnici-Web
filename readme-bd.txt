...
CREATE USER george WITH ENCRYPTED PASSWORD 'george';
GRANT ALL PRIVILEGES ON DATABASE cti_2024 TO george ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO george;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO george;